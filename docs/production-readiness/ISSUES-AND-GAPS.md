...
| Month-3 article 17 (Receiving $500 from a US client in India) | 🟢 Shipped 2026-08-04: worked ₹-landed table across Wise / Payoneer / bank wire / PayPal at an illustrative ₹86/USD snapshot (≈ ₹42,560 vs ≈ ₹39,650 — ~7% spread between channels), FIRC + FEMA + Section 44ADA notes (editorial, not tax advice), scenario picks, remittance + FX-markup calculator links. Distinct calculations per the plan's "no near-identical amount pages" rule. RSS 14 items, sitemap 88 URLs, 266 JSON-LD blocks |
| Month-3 article 23 (International payment settlement times) | 🟢 Shipped 2026-08-04: 8-rail timeline table (UPI/IMPS instant, NEFT ~30 min, RTGS real-time, gateway T+1 standard with T+0 caveats + merchant-hold/refund dynamics, Wise minutes–hours, Payoneer 1–2 days, SWIFT 2–5 days with correspondent-chain explanation), business-scenario picks, tool cross-links. Also aligned the receiving-$500 article to the same ₹86/USD vintage as the Payoneer fees article (was ₹83 — two same-week vintages). RSS 15 items, sitemap 89 URLs, 270 JSON-LD blocks, budget 421,601/450,000 |
