...
export const part_1_Articles: Article[] = [
  {
  ...
  },
  {
    ...
    relatedArticleSlugs: ["razorpay-vs-stripe-payments-india","razorpay-vs-cashfree-indian-gateways","brex-vs-relay-business-banking","best-payment-gateway-shopify-india","payment-gateway-fee-comparison-india","best-payment-gateway-indian-startups"],
    ctas: [
  ...
  },
  {
    ...
    relatedArticleSlugs: ["razorpay-vs-cashfree-indian-gateways","best-payment-gateway-small-business","razorpay-vs-stripe-for-developers","payment-gateway-for-subscription-businesses","stripe-vs-paypal-online-payments","payment-gateway-fee-comparison-india","best-payment-gateway-indian-startups","best-payment-gateway-indian-saas","razorpay-international-payment-fees"],
    ctas: [
  ...
  },
  {
    ...
    relatedArticleSlugs: ["razorpay-vs-stripe-payments-india","best-payment-gateway-small-business","razorpay-vs-cashfree-for-ecommerce","payment-gateway-fee-comparison-india","best-payment-gateway-indian-startups"],
    ctas: [
      { slug: "razorpay", label: "Visit Razorpay", placement: "compare-vs" },
